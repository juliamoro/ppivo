...
// Создание фабрики и образца парсера
    ...
    private class XMLHandler extends DefaultHandler { //обработчик его событий это наш класс
        @Override
        // Событие Тут логика реакции на начало элемента
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException{
            //Событие Тут логика реакции на конец элемента
            if(qName.equals("pet")){
                petList.add(new Pet(
                        petName,
                        petBirthday,

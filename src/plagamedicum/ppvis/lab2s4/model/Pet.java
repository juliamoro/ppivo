...
public class Pet {
	...
	public Pet(String petName, LocalDate petBirthday, LocalDate petLastAppointment, plagamedicum.ppvis.lab2s4.model.snpOfVeterinarian snp, String diagnosis){
	...
	public plagamedicum.ppvis.lab2s4.model.snpOfVeterinarian getSnp(){
		return snp;
	}

...
public class RequestElement { //Элемент запроса
    ...
    public enum criteriaForRequesting { //критерии для запроса
    ...
    private void switchPreset(){ //панель управления
    ...
    private void initCriteriaLists(){ //Списки критериев инициализации
